# cross-subject(subject id) => train: 3, 4, 6, 7, 9, 12, 13, 15, 17, 19, 25 | test: remaning
# cross-view(camera id) => CV1(train): 1, CV2(train): 1, 3, 4, 6, 7
# cross-view(camera id) => common (validation: 5, test: 2)
#
# this code will build a csv files that follow below structures
...
def cross_subset(videos_root_path: str, save_path: str) -> None:
